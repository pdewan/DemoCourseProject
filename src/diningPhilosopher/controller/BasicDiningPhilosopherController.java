...
public class BasicDiningPhilosopherController implements ConsoleController {
	 Scanner scanner;
	...
	public void processInput() {
		...
		DiningPhilosopherUtil.setNumberOfPhilosphers(aNumberOfPhilosophers);
		while (true) {
			...
			DiningPhilosopherUtil.setNewCourseTime(aTimeToEat);			
		}
	}
